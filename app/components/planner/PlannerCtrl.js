...
PlannerCtrl.$inject = ['SessionsService', 'EventService', 'moment', '$mdDialog']
 ...
 */
function PlannerCtrl(SessionsService, EventService, moment, $mdDialog) {
    var vm = this
    ...
    vm.showSession = function(session, ev) {
        $mdDialog.show({
            controller: "PlannerSessionCtrl",
            templateUrl: 'plannerSession.html',
